        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center space-y-16">
            ...
            <div className="w-full">
              <div className="relative max-w-3xl mx-auto bg-gradient-to-br from-amber-50 via-amber-50 to-amber-100 rounded-3xl p-10 md:p-14 shadow-xl border border-amber-100/60">
                ...
                <div className="relative">
                  <div className="space-y-8">
                    <div className="flex items-start space-x-5">
                      <div className="bg-amber-100/80 backdrop-blur rounded-full p-4 shadow-inner">
                    ...
                    <div className="flex items-start space-x-5">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 font-semibold text-lg">Hotel Green Court</p>
                  ...
                  <button
                    onClick={openMap}
                    className="w-full mt-12 bg-gradient-to-r from-[#9f7433] to-[#b18339] hover:from-[#b18339] hover:to-[#8d652d] text-white font-semibold py-4 px-8 rounded-xl hover:from-[#b18339] hover:to-[#8d652d] transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-amber-200/60 hover:shadow-2xl transform hover:scale-105"
                  >
                    <Navigation size={22} />
